...
export class ProjectsComponent {
  ...
  projects = [
    ...
    { name: 'Encurtador de URLs', description: 'Encurtador de URLs desenvolvido em Node.js. O usuário insere uma URL e recebe uma URL encurtada. O projeto foi desenvolvido durante o curso de Node.js da Rocketseat.', technologies: 'Node.js, Express, TypeScript, Prisma ORM e Sqlite.', link: '', codeLink: 'https://github.com/joaopedrodevl/encurtador_url', status: 'Concluído'},
  ];
}
